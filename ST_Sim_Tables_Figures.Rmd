...
# Make the plots
y_N <- ggplot(df_converged, aes(n_years, mean_N_est, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = mean(df_converged$mean_N, na.rm = T), linetype = 2, size = 1, colour = "red") + theme(legend.position = "top") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + ylim(0, 50)

y_N_se <- ggplot(df_converged, aes(n_years, N_se, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + ylim(0,15)

y_gamma <- ggplot(df_converged, aes(n_years, gamma_j_hat, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$gamma_j, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + ylim(0, 0.35)

y_RMSE <- ggplot(df_converged, aes(n_years, RMSE, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + scale_y_continuous(limits = c(5, 40)) + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10)

y_theta <- ggplot(df_spatial, aes(n_years, theta_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE"))  + theme(legend.position="none") + geom_hline(yintercept = df_spatial$theta, linetype = 2, size = 1, colour = "red") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + ylim(0, 5)

y_rhot <- ggplot(df_converged, aes(n_years, rhot_hat, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_y_continuous(limits = c(-1, 1)) + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$rhot, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10)

y_sigmat <- ggplot(df_converged, aes(n_years, sigmat_hat, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_y_continuous(limits = c(0, 2.25)) + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$sigmat, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10)

y_thet_st <- ggplot(df_spatial, aes(n_years, theta_st_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + scale_y_continuous(limits = c(0, 0.75)) + geom_hline(yintercept = df_spatial$theta_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + geom_text(x = 5, y = 65, label = "b", size = 10)

y_rho_st <- ggplot(df_spatial, aes(n_years, rho_st_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + scale_y_continuous(limits = c(-0.5, 1)) + geom_hline(yintercept = df_spatial$rho_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + geom_text(x = 5, y = 65, label = "b", size = 10)
...
# Make the plots
s_N <- ggplot(df_converged, aes(n_sites, mean_N_est, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = mean(df_converged$mean_N, na.rm = T), linetype = 2, size = 1, colour = "red") + theme(legend.position = "top") + xlab("") + ylim(0, 50)

s_N_se <- ggplot(df_converged, aes(n_sites, N_se, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF")) + theme(legend.position = "none") + xlab("") + ylim(0, 10)

s_gamma <- ggplot(df_converged, aes(n_sites, gamma_j_hat, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF")) + geom_hline(yintercept = df_converged$gamma_j, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + xlab("") + ylim(-0.1, 0.5)

s_RMSE <- ggplot(df_converged, aes(n_sites, RMSE, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF")) + scale_y_continuous(limits = c(5, 50)) + theme(legend.position = "none") + xlab("")

s_theta <- ggplot(df_spatial, aes(n_sites, theta_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"))  + theme(legend.position="none") + geom_hline(yintercept = df_spatial$theta, linetype = 2, size = 1, colour = "red") + xlab("") + ylim(0, 6)

s_rhot <- ggplot(df_converged, aes(n_sites, rhot_hat, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_y_continuous(limits = c(-1, 1)) + scale_fill_manual(values=c("#F8766D", "#619CFF")) + geom_hline(yintercept = df_converged$rhot, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + xlab("")

s_sigmat <- ggplot(df_converged, aes(n_sites, sigmat_hat, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_y_continuous(limits = c(0, 2.25)) + scale_fill_manual(values=c("#F8766D", "#619CFF")) + geom_hline(yintercept = df_converged$sigmat, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + xlab("")

s_thet_st <- ggplot(df_spatial, aes(n_sites, theta_st_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF")) + scale_y_continuous(limits = c(0, 0.75)) + geom_hline(yintercept = df_spatial$theta_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none")

s_rho_st <- ggplot(df_spatial, aes(n_sites, rho_st_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF")) + scale_y_continuous(limits = c(0.25, 1)) + geom_hline(yintercept = df_spatial$rho_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none")
...
s_grid <- arrangeGrob(s_theta + xlab(""), legend, 
             s_N + xlab(""), s_N_se + xlab(""), 
             s_thet_st + xlab(""), s_rho_st + xlab(""),
