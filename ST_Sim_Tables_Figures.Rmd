...
st_grid <- arrangeGrob(p_true[[2]] + ggtitle("True N: Year 2") + theme(legend.position="none", axis.title.x = element_blank()),
             p_true[[4]] + ggtitle("True N: Year 4") + theme(legend.position="none", axis.title.x = element_blank(), axis.title.y = element_blank()),
             p_true[[6]] + ggtitle("True N: Year 6") + theme(legend.position="none", axis.title.x = element_blank(), axis.title.y = element_blank()),
             p_true[[8]] + ggtitle("True N: Year 8") + theme(legend.position="none", axis.title.x = element_blank(), axis.title.y = element_blank()),
             p_true[[10]] + ggtitle("True N: Year 10") + theme(legend.position="none", axis.title.x = element_blank(), axis.title.y = element_blank()),
             my_legend,
