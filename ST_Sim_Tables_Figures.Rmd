...
# Make the plots
y_N <- ggplot(df_converged, aes(n_years, mean_N_est, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = mean(df_converged$mean_N, na.rm = T), linetype = 2, size = 1, colour = "red") + theme(legend.position = "top") + ylab("Mean density") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 25))

y_N_se <- ggplot(df_converged, aes(n_years, N_se, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + theme(legend.position = "none") + ylab(expression("Mean SE of density")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 3.5)) # *widehat("N")

y_gamma <- ggplot(df_converged, aes(n_years, gamma_j_hat, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$gamma_j, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Fixed effect")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(-0.05, 0.45)) # (", gamma, ")

y_RMSE <- ggplot(df_converged, aes(n_years, RMSE, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 25))

y_theta <- ggplot(df_spatial, aes(n_years, theta_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE"))  + theme(legend.position="none") + geom_hline(yintercept = df_spatial$theta, linetype = 2, size = 1, colour = "red") + ylab(expression("Spatial decay")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0.1, 0.55)) # (", theta[epsilon], ")"

y_SD <- ggplot(df_spatial, aes(n_years, SD_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$SD, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Asymptotic spatial variation")) + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 1)) #(", sigma[epsilon], ")"

y_rhot <- ggplot(df_converged, aes(n_years, rhot_hat, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$rhot, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Temporal correlation")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(-1, 1)) # (", rho[delta], ")"

y_sigmat <- ggplot(df_converged, aes(n_years, sigmat_hat, group = interaction(n_years, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$sigmat, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Temporal variation")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 0.45)) # (", sigma[t], ")

y_thet_st <- ggplot(df_spatial, aes(n_years, theta_st_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$theta_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Spatio-temporal decay")) + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0.1, 0.6)) #  (", theta[st], ")

y_SD_st <- ggplot(df_spatial, aes(n_years, SD_st_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$SD_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Asymptotic ST variation")) + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0.1, 1)) # (", sigma[nu], ")

y_rho_st <- ggplot(df_spatial, aes(n_years, rho_st_hat, group = n_years)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$rho_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Temporal decay")) + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0.4, 1)) #  (", rho[st], ")
...
rmse_20 <- ggplot(df_rmse_st, aes(n_sites, RMSE, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 25))
...
# Make the plots
s_N <- ggplot(df_converged, aes(n_sites, mean_N_est, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = mean(df_converged$mean_N, na.rm = T), linetype = 2, size = 1, colour = "red") + theme(legend.position = "top") + ylab("Mean density") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(5, 25))
...
s_gamma <- ggplot(df_converged, aes(n_sites, gamma_j_hat, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$gamma_j, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Fixed effect")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(-0.3, 0.62))

s_RMSE <- ggplot(df_converged, aes(n_sites, RMSE, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + theme(legend.position = "none") + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 25))

s_theta <- ggplot(df_spatial, aes(n_sites, theta_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE"))  + theme(legend.position="none") + geom_hline(yintercept = df_spatial$theta, linetype = 2, size = 1, colour = "red") + ylab(expression("Expected spatial decay")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0.08, 0.75))

s_SD <- ggplot(df_spatial, aes(n_sites, SD_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$SD, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Asymptotic spatial variation")) + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 0.9))

s_rhot <- ggplot(df_converged, aes(n_sites, rhot_hat, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$rhot, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Temporal correlation")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(-1, 1))

s_sigmat <- ggplot(df_converged, aes(n_sites, sigmat_hat, group = interaction(n_sites, spatialTF))) + geom_boxplot(aes(fill = factor(spatialTF)), outlier.colour = "NA") + scale_fill_manual(values=c("#F8766D", "#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_converged$sigmat, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Temporal variation")) + xlab("") + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0, 0.5))

s_thet_st <- ggplot(df_spatial, aes(n_sites, theta_st_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$theta_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Spatio-temporal decay")) + geom_text(x = 5, y = 65, label = "b", size = 10) +  coord_cartesian(ylim = c(0.05, 0.75))

s_SD_st <- ggplot(df_spatial, aes(n_sites, SD_st_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$SD_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Asymptotic ST variation")) + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0.15, 1.1))

s_rho_st <- ggplot(df_spatial, aes(n_sites, rho_st_hat, group = n_sites)) + geom_boxplot(aes(fill = "#619CFF"), outlier.colour = "NA") + scale_fill_manual(values=c("#619CFF"), name = "Spatial", labels = c("FALSE", "TRUE")) + geom_hline(yintercept = df_spatial$rho_st, linetype = 2, size = 1, colour = "red") + theme(legend.position = "none") + ylab(expression("Temporal decay")) + geom_text(x = 5, y = 65, label = "b", size = 10) + coord_cartesian(ylim = c(0.3, 1))
